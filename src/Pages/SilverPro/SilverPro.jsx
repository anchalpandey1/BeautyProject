...
import img6 from '../../assets/SliverPro/Rectangle 651.png'
import img7 from '../../assets/SliverPro/ion_diamond-outline.png'
import img8 from '../../assets/SliverPro/Group 317.png'
                ...
                <div className=' flex flex-row justify-center gap-5 mt-10'>
                    ...
                    <div className=' flex  flex-col gap-5  '>
                        <div className=' hidden lg:w-[1040px] rounded-[24px] h-vh lg:flex justify-between bg-gradient-to-r from-[#DFDDDD] '>
                            <div className=' w-[50%] pt-20 px-10 flex flex-col gap-10'>
                                ...
                                <div className=' flex  gap-5'>
                                    <NavLink to="/SilverPro"><button className=' border border-[#BEBEBE] rounded-[12px] scale-125  bg-white flex justify-center px-10 py-2 items-center p-2 text-[20px] font-[700]'>Sliver</button>
                                    </NavLink>
                                    <NavLink
                                        to="/GoldPro"><button className=' border border-[#BEBEBE] rounded-[12px] bg-[#FFF] flex justify-center items-center p-2 px-10 text-[18px] font-[400] text-[#989898] '>Gold</button>
                                    </NavLink>
                                    <NavLink
                                        to="/PlatinumPro"><button className=' border border-[#BEBEBE] rounded-[12px] bg-[#FFF] flex justify-center items-center p-2 px-10  text-[18px] font-[400] text-[#989898]'>Platinum</button>
                                    </NavLink>
                                </div>
                        ...
                        <div className='lg:hidden flex items-center justify-center  gap-5'>
                            <NavLink to="/SilverPro"><button className=' border border-[#BEBEBE] rounded-[12px] scale-125  bg-white flex justify-center px-5 py-2 items-center p-2 text-[14px] font-[700]'>Sliver</button>
                            </NavLink>
                            <NavLink
                                to="/GoldPro"><button className=' border border-[#BEBEBE] rounded-[12px] bg-[#FFF] flex justify-center items-center p-2 px-5 text-[12px] font-[400] text-[#989898] '>Gold</button>
                            </NavLink>
                            <NavLink
                                to="/PlatinumPro"><button className=' border border-[#BEBEBE] rounded-[12px] bg-[#FFF] flex justify-center items-center p-2 px-5  text-[12px] font-[400] text-[#989898]'>Platinum</button>
                            </NavLink>
                        </div>
