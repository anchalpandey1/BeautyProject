...
const ProductReviewFull = () => {
  
    return (
      
      <div className='w-full bg-[#F3EFEF] py-1 min-h-screen flex'>
      <div className="bg-white shadow-lg p-4 rounded-lg mx-auto w-full sm:w-full md:w-[80%] lg:w-[70%] xl:w-[65%] font-SulphurPoint overflow-x-hidden">
        ...
        <div>        
                ...
                <div class="w-24 h-auto">
                 <img src={imge1} alt="Small Image" class="w-full h-auto"/>
                  ...
                  <p className="absolute top-0 right-0 text-[#989898] m-2 font-SulphurPoint">
                   07/09/2023
                  </p>               
                  <div >
      ...
      <button className="border w-full border-[#A21D3C] bg-white text-[#A21D3C] px-4 py-2 rounded">
        Load More
      </button>
      ...
      {/*<div className=' my-2 md:my-4 lg:my-6 font-SulphurPoint font-normal text-base md:text-lg lg:text-xl xl:text-2xl text-[#2D2D2D]'>
               ...
               <div class="w-40 h-40">
                ...
                <div className="hidden sm:block p-4 rounded-lg mx-auto w-[15%] font-SulphurPoint"></div>
      </div>
    )
}
export default ProductReviewFull