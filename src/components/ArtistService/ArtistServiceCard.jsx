...
const ArtistServiceCard = () => {
    ...
    const displayArtist = ()=>{
        navigate(`/artistPage/${id}`,{replace : true})
    }
    return (
        <>

        <div onClick={displayArtist} className='cursor-pointer w-fit w-[180px]s h-[300px]s bg-[#FFFFFF] p-3 lg:p-4 rounded-xl lg:rounded-2xl shadow-productCardSmall md:shadow-productCard' >
