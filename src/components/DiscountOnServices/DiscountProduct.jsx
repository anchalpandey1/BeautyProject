...
import DeliveryBy from '../../components/DeliveryBy/DeliveryBy'

const DiscountOnServies = () => {
    return (

        <div className='w-[25%] bg-[#F3EFEF] py-[1rem] md:py-[2rem] h-fit '>
            <DeliveryBy/>
            <div className='w-[95%] xs:w-[95%] md:w-[95%] lg:w-[95%] max-w-[390px]s mx-auto  justify-center xs:justify-between md:max-w-[1000px]
            ...
            '>
                ...
                md:bg-gradient-to-r from-[#E5CAD0] to-[#FAF4D4] mt-4 mb-4
